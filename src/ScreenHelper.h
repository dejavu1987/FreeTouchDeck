...
/**
 * @brief This function returns the RGB565 colour of the first pixel of the
 * image which is being latched to for a given the logo number. The pagenumber
 * is global.
 *
 * @param logonumber int
 *
