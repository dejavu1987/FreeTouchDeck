# FreeTouchDeck Lite\* (No WIFI - PlatformIO)
...
This is a stripped down version of FreeTouchDeck. I had issues with booting my esp32-s3 with WiFi so had to work without WiFi.

I have stripped away all the code that was related to Wifi config and Webserver. That means the configuration will be limited either to what ever is hard coded, or.... I am trying to find best way to make config. The options that I have in mind?
...
If you are interested to contribute feel free to fork PRs will me more than welcome.

Regards
Anil

Annnd I am using PlatformIO which means the source files are moved to `src/` and `FreeTouchDeck.ino` is `main.cpp` if you want to work on Arduino IDE please change them and it should work fine.

Below this line is README from Original Repo.

---

**_Version 0.9.18a remark: This version might be unstable due to current work on adding support for the ESP32-S3. Last stable is 0.9.17 which you can find in the Releases section._**
